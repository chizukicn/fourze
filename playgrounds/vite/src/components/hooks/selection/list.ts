...
export const listProps = {
    ...
    beforeChange: {
        type: Function as PropType<((newVal: BaseType, oldVal: BaseType) => BaseType) | undefined>,
        default: null
    },
...
export const useSelectionList = defineHooks(listProps, (props, context) => {
    ...
    function changeActive(option: BaseType) {
        if (props.beforeChange) {
            option = props.beforeChange(option, props.modelValue) ?? option
        }
